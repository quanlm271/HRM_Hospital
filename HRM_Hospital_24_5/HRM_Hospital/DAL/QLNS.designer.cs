...
namespace HRM_Hospital.DAL
{
    ...
    partial void DeleteTHANNHAN(THANNHAN instance);
		...
		public QLNSDataContext() : 
				base(global::HRM_Hospital.Properties.Settings.Default.QLNSConnectionString2, mappingSource)
		{
			OnCreated();
		}
		...
		public NHANVIEN NHANVIEN
		{
			...
			set
			{
							...
							|| (this._NHANVIEN.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._NHANVIEN.Entity = null;
						previousValue.DONXINs.Remove(this);
					}
					this._NHANVIEN.Entity = value;
					if ((value != null))
					{
						value.DONXINs.Add(this);
						this._MANV = value.MANV;
					}
					else
					{
    ...
    partial void OnLOAINVChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHANVIEN_DONXIN", Storage="_DONXINs", ThisKey="MANV", OtherKey="MANV")]
		public EntitySet<DONXIN> DONXINs
		{
			get
			{
				return this._DONXINs;
			}
			set
			{
				this._DONXINs.Assign(value);
			}
		}
		...
		private void attach_DONXINs(DONXIN entity)
		{
			this.SendPropertyChanging();
			entity.NHANVIEN = this;
		}
		
		private void detach_DONXINs(DONXIN entity)
		{
			this.SendPropertyChanging();
			entity.NHANVIEN = null;
		}
